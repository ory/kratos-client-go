...
# Contribute to Ory Ory Kratos Go Client<!-- omit in toc -->
...
Ory Kratos Go Client's direction. A great way to
do this is via
...
- **Help with open issues.** We have a lot of open issues for Ory Ory Kratos Go Client and
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/kratos-client-go/blob/master/.github/workflows/conventional_commits.yml)
